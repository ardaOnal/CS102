...
public class IntBag
{
    ...
    * @param int inputValue is the value that will be added to the array.
    * @param int index is the location where it will be added to the array.
    ...
    * @param int index is the index that the value will be removed.
    */
    ...
    * @param int inputValue will be checked if it is in the array or not.
    */
